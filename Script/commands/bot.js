...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var rand = tl[Math.floor(Math.random() * tl.length)]
    ...
    if ((event.body.toLowerCase() == "😘") || (event.body.toLowerCase() == "😽")) {
     return api.sendMessage("Kiss dio na jan amar sorom kore..🤭🫣", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "@Rɩʆʌt Kʜʌŋ") || (event.body.toLowerCase() == "simsimi")) {
     return api.sendMessage("কিরে তোর এতো সাহস আমার বসের নাম ধরিস😾🫵", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "Rifat") || (event.body.toLowerCase() == "Rifat vai") || (event.body.toLowerCase() == "@Rɩʆʌt Kʜʌŋ") || (event.body.toLowerCase() == "রিফাত")) {
   ...
   if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "ceo")) {
     return api.sendMessage("‎[𝐎𝐖𝐍𝐄𝐑:☞ R I F A T ッ ☜\n𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 Rifat.\n𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝 :- https://www.facebook.com/share/16GtaQ6s4m/তার সাতে যোগা যোগ করবেন WhatsApp :- +01308087847", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "admin") || (event.body.toLowerCase() == "boter admin")) {
     return api.sendMessage("He is R I F A T ッ❤️ তাকে সবাই রিফাত নামে  চিনে🤙", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "আসসালামু আলাইকুম") || (event.body.toLowerCase() == "Assalamualaikum") || (event.body.toLowerCase() == "Assalamu alaikum") || (event.body.toLowerCase() == "Salam ")) {
   ...
   if ((event.body.toLowerCase() == "sala ami tor boss") || (event.body.toLowerCase() == "sala ami rifat") || (event.body.toLowerCase() == "cup sala ami rifat") || (event.body.toLowerCase() == "madari")) {
  ...
  if ((event.body.toLowerCase() == "tamsi") || (event.body.toLowerCase() == "arohi")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার বস RIFAT এর বউ এর নাম..!😠🥰⛏️", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "siddik") || (event.body.toLowerCase() == "farhan")) {
     return api.sendMessage("🥰--🌺 আমার বস রিফাত'র বন্ধু লাগে লুচ্ছি বেডি'রা দূরে থাক😠🥰⛏️", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "tnx") || (event.body.toLowerCase() == "ধন্যবাদ") || (event.body.toLowerCase() == "thank you") || (event.body.toLowerCase() == "thanks")) {
     return api.sendMessage("️এতো ধন্যবাদ না দিয়ে পারলে আমার বস রিফাতকে দুই তিনটা গার্লফ্রেন্ড দে..!🌚⛏️🌶️", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "Rifat kake valobashe") || (event.body.toLowerCase() == "Rifat ar gf ke")) {
     return api.sendMessage("️RIafAT boss shudhu tar first love rls key valo bashe..😌", threadID);
   };

   if ((event.body.toLowerCase() == "Name") || (event.body.toLowerCase() == "name") || (event.body.toLowerCase() == "Tor nam ki")) {
     return api.sendMessage("️MY NAME IS °_>RS. 𝗰𝗵𝗮𝘁. 𝗯𝗼t", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "sinthiya") || (event.body.toLowerCase() == "ex")) {
   ...
   if ((event.body.toLowerCase() == "@Rɩʆʌt Kʜʌŋ") || (event.body.toLowerCase() == "amake kew valobashe na") || (event.body.toLowerCase() == "Aj kew nai bole")) {
     return api.sendMessage("️রিফাত বস তো এখন প্রেমের ক্লাসে বসে আছে, পরে নক কর 😏📚", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "ami rifat") || (event.body.toLowerCase() == "kire ps")) {
